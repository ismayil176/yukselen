import { z } from "zod";
import { clearExamSessionCookie, getExamSession } from "@/lib/examSession";
import { getAttemptById, finishAttempt } from "@/lib/attempts";
import { assertSameOrigin, noStoreJson } from "@/lib/apiSecurity";
import { readDb, type SectionKey } from "@/lib/store";
import { getCategorySections, isCategoryKey, isSectionAllowedForCategory } from "@/lib/examStructure";
